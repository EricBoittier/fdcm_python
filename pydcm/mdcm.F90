...
!        if(allocated(fatom_num)) deallocate(fatom_num)
!        if(allocated(fatom_pos)) deallocate(fatom_pos)
        if(allocated(atom_fit)) deallocate(atom_fit)
        if(allocated(grid_sid)) deallocate(grid_sid)
        if(allocated(files_load_cube)) deallocate(files_load_cube)
        if(allocated(mdcm_nchg)) deallocate(mdcm_nchg)
